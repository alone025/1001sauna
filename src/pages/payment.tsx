    ...
    <div className="payment-content">
        ...
        <div className="contn mt-11 flex flex-col gap-2 sm:gap-5 sm:grid sm:grid-cols-2 lg:grid-cols-3">
                ...
                {priceDatas.map((sm, na)=> (
                     ...
                     <Button bgColor='#FF7A01' color='#FFF' rounded='12px' className="!text-[14px] sm:!text-base !font-OpenSans !font-semibold hover:!text-[#FF7A01] !h-12" >Картой</Button>
                     <Button borderColor='#CCCCCC' bg='transparent' rounded='12px' className="!text-[14px] sm:!text-base !font-OpenSans !font-semibold !border !h-12"  >По счёту</Button>
                     </div>
                     </div>
                ))}
