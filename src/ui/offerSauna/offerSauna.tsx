...
const OfferSauna = ({isOpen, onClose, onOpenSuccess}:{isOpen:boolean, onClose:()=>void, onOpenSuccess: ()=> void}) => {
  return (
    <Modal size='xl'   isOpen={isOpen} onClose={onClose}>
              <ModalOverlay />
              <ModalContent className="!px-4 !py-6 sm:!p-8 " >
              <div className="lg-tex flex mb-3 flex-row justify-between gap-10">
                <h3 className="text-xl lg:text-2xl text-[#3B4255] font-OpenSans font-semibold">Записаться</h3>
  ...
  <path d="M8 8L24 24" stroke="#3B4255" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <ModalBody p={0}>
                    ...
                    <OfferContent onOpenSuccess={onOpenSuccess}/>
                </ModalBody>
