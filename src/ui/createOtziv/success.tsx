...
const Success = ({isOpen, onClose}: {isOpen: boolean, onClose: ()=> void}) => {
  return (
  ...
  <path d="M80 24L36 68L16 48" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <h3 className="text-2xl text-[#3B4255] text-center max-w-[280px] font-OpenSans font-semibold">Заявка отправлена. Спасибо!</h3>
                    <button onClick={()=> window.location.reload()} className="text-sm sm:text-base text-white font-OpenSans font-semibold px-16 py-[9px] rounded-xl bg-[#FF7A01]">Вернуться на сайт</button>
                   </div>
