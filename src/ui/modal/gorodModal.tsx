  ...
  return (
    <div>
        <div className='bg-white relative rounded-[24px] w-full sm:w-[468px] h-[310px] sm:h-[275px] border font-OpenSans px-[32px]'>
                ...
                <button onClick={()=> saveDataToLocalStorage('Москва')} className='bg-[#FF7A01] transition-transform rounded-[12px] py-[8px] px-[64px] text-[14px] sm:text-[15px] md:text-[16px] hover:scale-[1.03] sm:max-w-[196px] w-full text-white flex justify-center items-center mt-[24px] h-[48px]'>
                Да
					</button>
                    <button onClick={()=> {
						openNavbarModal(); closeModal()
						}} className='border-[#FF7A01] border transition-colors hover:bg-[#fde6c58a] text-[14px] sm:text-[15px] md:text-[16px] text-[#FF7A01] rounded-[12px] py-[8px] px-[24px] w-full sm:max-w-[196px] flex justify-center items-center sm:mt-[24px] h-[48px]'>
					Выбрать регион
					</button>
                </div>
				</div>
